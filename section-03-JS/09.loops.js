...
console.log("-------------------");
console.log("LOOPS Ejercicio1");
// EJERCICIO - 001
// Dado un array, devuelve el tipo de dato que hay en cada una de sus posiciones.

const exerciseArray = [1, 2, "h", 1, true, "2", "h", 2, false];
for (let i = 0; i < exerciseArray.length; i++) {
    console.log(typeof(exerciseArray[i]));
}
...
const famousPeople = ["Johnny Depp", "Malcom X", "Jeff Bezos"];
for (let i = 0; i < famousPeople.length; i++) {
    console.log(`. ${famousPeople[i]} is os famous, I love them`);
  }
